...
from src.core.coordinator import AgentStatus, AgentMetrics
...
class EnhancedMonitoringSystem:
    ...
    async def generate_progress_report(
        ...
        health_score = self._calculate_health_score(
            agent_metrics, agent_status, task_counts
        )
        ...
        recommendations = self._generate_recommendations(
            agent_metrics, agent_status, bottlenecks
        )
        ...
        # Log report
        logger.info(
            "System progress report generated",
            **report.to_dict()
        )
    ...
    def _calculate_health_score(
        ...
        avg_recovery_rate = sum(m.recovery_attempts for m in agent_metrics.values()) / len(agent_metrics)
    ...
    def _identify_bottlenecks(
        ...
        stuck_agents = [
            agent_id for agent_id, status in agent_status.items()
    ...
    def _generate_recommendations(
        ...
        avg_success_rate = sum(m.success_rate for m in agent_metrics.values()) / len(agent_metrics) if agent_metrics else 0
