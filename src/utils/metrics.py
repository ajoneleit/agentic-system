...
class AgenticMetrics:
    ...
    def _init_metrics(self) -> None:
        ...
        self.session_duration = Summary(
            'agentic_session_duration_seconds',
    ...
    @contextmanager
    def timer(self, metric_name: str, labels: Optional[Dict[str, str]] = None) -> Generator[None, None, None]:
