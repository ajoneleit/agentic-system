...
from .observability import setup_observability, get_performance_tracker
...
class ObservabilityManager:
    ...
    def initialize(self) -> None:
        ...
        if (self.settings.observability.enable_structured_logging and 
            self.settings.observability.enable_metrics):
            setup_observability()
    ...
    def _start_metrics_server(self) -> None:
        ...
        try:
            start_http_server(
                self.settings.observability.metrics_port,
        ...
        def monitor_system():
            ...
            while not self._shutdown_event.is_set():
                try:
                    ...
                    self._shutdown_event.wait(self.settings.observability.metrics_collection_interval)
    ...
    def get_health_status(self) -> dict:
        ...
        if self.settings.observability.enable_metrics:
            ...
            status["metrics_endpoint"] = f"http://localhost:{self.settings.observability.metrics_port}/metrics"
