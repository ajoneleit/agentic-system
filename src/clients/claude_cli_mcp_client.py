...
from src.utils.subprocess_manager import SafeSubprocessManager, CLIExecutionResult
...
class ClaudeCodeMCPClient:
    ...
    def __init__(self):
        ...
        logger.info(
            "Claude CLI MCP client initialized",
    ...
    async def _parse_cli_output(self, result: CLIExecutionResult, task_id: str) -> Dict[str, Any]:
        ...
        code_matches = re.findall(r'```(?:python|javascript|typescript|java|go)?\n(.*?)\n```', output, re.DOTALL)
