    ...
    def create_temp_file(
        ...
        try:
            ...
            try:
                ...
                logger.debug("Temporary file created", path=str(temp_file_path), size=len(content))
    ...
    def _cleanup_all_files(self) -> None:
        ...
        for file_path in files_to_cleanup:
            try:
                ...
                logger.warning(
                    "Failed to cleanup file during bulk cleanup", path=str(file_path), error=str(e)
                )
...
def create_temp_file(
    content: str, suffix: str = ".md", prefix: str = "claude_prompt_", encoding: str = "utf-8"
) -> Result[Path]:
