...
class ArtifactFactory:
    ...
    def create_documentation_artifact(
        ...
        try:
            ...
            return Result.failure(ArtifactError(f"Failed to create documentation artifact: {str(e)}"))
    ...
    def create_configuration_artifact(
        ...
        try:
            ...
            return Result.failure(ArtifactError(f"Failed to create configuration artifact: {str(e)}"))
    ...
    def _count_test_functions(self, content: str) -> int:
        ...
        for line in lines:
            ...
            if (stripped.startswith('def test_') or 
                ...
                stripped.startswith('function test')):
                count += 1
